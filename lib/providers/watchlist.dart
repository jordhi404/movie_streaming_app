...
class WatchListProvider extends ChangeNotifier {
  static final String _databaseId = appwrite.ID.custom("deafult2");
  ...
  Future<List<Entry>> list() async {
    ...
    final entries = 
    (await ApiClient.database.listDocuments(databaseId: _databaseId, collectionId: appwrite.ID.custom('movies'))).documents.map((document) => Entry.fromJson(document.data)).toList();
